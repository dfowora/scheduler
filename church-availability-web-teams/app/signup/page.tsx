...
function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!data.session) {
      setErrorMessage('Account created, but sign-in requires email confirmation to be disabled. Contact your coordinator.');
      return;
    }
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display text-4xl text-moss-900 mb-8">Create your account</h1>
        ...
        <p className="text-sm text-moss-400 mt-4">
          ...
          <a href="/login" className="text-moss-600 underline">
            Sign in
          </a>
        </p>
      </div>
